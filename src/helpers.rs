...
/// assert_eq!(error.detail(), Some("Email format is invalid"));
/// ```
...
/// assert_eq!(error.detail(), Some("No valid authentication token provided"));
/// ```
...
/// assert_eq!(error.detail(), Some("You do not have permission to access this resource"));
/// ```
...
/// assert_eq!(error.detail(), Some("The requested user does not exist"));
/// ```
...
/// assert_eq!(error.detail(), Some("POST method is not supported for this endpoint"));
/// ```
...
/// assert_eq!(error.detail(), Some("A user with this email already exists"));
/// ```
...
/// assert_eq!(error.detail(), Some("Password must be at least 8 characters"));
/// ```
...
/// assert_eq!(error.detail(), Some("Rate limit exceeded. Please try again later"));
/// ```
...
/// assert_eq!(error.detail(), Some("Database connection failed"));
/// ```
...
/// assert_eq!(error.detail(), Some("Upstream service returned an invalid response"));
/// ```
...
/// assert_eq!(error.detail(), Some("Database is currently under maintenance"));
/// ```
...
/// assert_eq!(error.detail(), Some("Upstream service did not respond in time"));
/// ```
